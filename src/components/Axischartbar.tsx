...
export default function ReverseExample() {
  ...
  return (
    <Stack sx={{ width: '100%', color: '#fff' }}>
      <Stack direction="row">
        <FormControlLabel
          checked={reverseX}
          control={
            <Checkbox
              onChange={(event) => setReverseX(event.target.checked)}
              sx={{ color: '#fff' }}
            />
          }
      ...
      <Box sx={{ width: '100%' }}>
          ...
          xAxis={[
            {
              ...
              label: 'Month',
              reverse: reverseX,
              labelStyle: { fill: '#fff' },       // White axis label
              tickLabelStyle: { fill: '#fff' },   // White tick text
            },
          ]}
          yAxis={[
            {
        ...
        >
          ...
          <MarkPlot />
          <ChartsXAxis />
          <ChartsYAxis   axisId="leftAxis" label="Buyer" />
          <ChartsYAxis axisId="rightAxis" label="Seller" />
          <ChartsTooltip />
        </ChartContainer>
      </Box>
    </Stack>
